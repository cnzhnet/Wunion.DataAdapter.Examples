...
namespace Wunion.DataAdapter.CodeFirstDemo.Data.Domain
{
    ...
    public class MyDbContext : DbContext
    {
        ...
        /// 资源的语言环境表.
        /// </summary>
        public DbTableContext<ResourceLocale> ResourceLocales => TableDeclaration<ResourceLocale>("ResourceLocales");

        /// <summary>
        /// 通用分类型.
        /// </summary>
        public DbTableContext<GeneralCategory> GeneralCategories => TableDeclaration<GeneralCategory>("GeneralCategories");

        /// <summary>
        /// 文档目录表.
        /// </summary>
        public DbTableContext<DocumentCatalog> DocumentCatalogs => TableDeclaration<DocumentCatalog>("DocumentCatalogs");

        /// <summary>
        /// 文档内容表.
        /// </summary>
        public DbTableContext<Documentation> Documentation => TableDeclaration<Documentation>("Documentation");
        ...
        public override void OnBeforeGenerating(IGeneratingOptions options)
        {
            ...
            options.Database.SchemaVersion = 2; //当前的数据库架构版本.
        ...
        public override void OnGenerateCompleted(Action<string> log)
        {
            ...
            using (BatchCommander batch = new BatchCommander(DbEngine))
            {
                try
                {
                    ...
                    // 预置区域语言
                    log("正在预置区域语言 ...");
                    ResourceLocales.Add(new ResourceLocale { Name = "zh-CN", DisplayName = "简体中文(中国)", Creation = creation }, batch);
                    ResourceLocales.Add(new ResourceLocale { Name = "en-US", DisplayName = "English (US)", Creation = creation }, batch);
                    // 预置用户账户组.
                    log("正在预置管理员用户组 ...");
